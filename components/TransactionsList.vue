<template>
  <div class="row">
    <div class="col-12 mt-5 d-grid gap-2" v-for="transaction in transactions" :key="transaction.id">
      <h6 class="mb-2 font-weight-bold">{{ transaction.date }}</h6>
      <aside class="card py-3">
        <div class="col-12 align-items-center d-flex justify-content-between">
          <div class="flex-column d-flex">
            <span class="badge bg-primary text-white p-2 px-4 mb-2" style="width:fit-content">{{ transaction.categoryId }}</span>
          ...
          <div class="d-flex align-items-center text-right">
            ...
            <button class="btn" @click="payment.is_payable = !payment.is_payable" :key="transaction.id">
        ...
        <transition mode="out-in">
          <div class="card-body" v-show="payment.is_payable" :key="transaction.id">
            <div class="row">
...
export default {
  ...
  async fetch() {
    this.transactions = await this.$store.dispatch('transactions/getTransactions')
  },
